...
//	private static final String TAG = "SetAccountActivity";
	...
	private EditText qianMing_et;//个性签名文本框
	...
	public void click(View view) {
        ...
        preferences.edit().putString("qianMing", qianMing).putString("city", city).putString("realName", realName).commit();
        new MPush(SetAccountActivity.this).setSexTag(preferences.getString("sex", "woman"),new MPush(this).getDeviceId());
	}
	//真实姓名说明按钮点击事件
	public void hintClick(View view) {
		new AlertDialog.Builder(this).setTitle("说明").setMessage(view.getContentDescription()).setPositiveButton("确定", null).show();
	}
}
